        ...
        case 1:
          if (this.canChange) {
            this.centerPos = {
              ...
              y: Math.floor((e.clientY + this.rightMiddlePoint.y) / 2) // div旋转位水平角的位置

            };
            newLeftTopPoint = this.getRotatedPoint({
              x: e.clientX,
              y: e.clientY
            }, this.centerPos, -this.initAngle); // 左上角旋转为水平的角度
            ...
            newHeight = newRightBottomPoint.y - newLeftTopPoint.y; //  if (this.isScale) {
